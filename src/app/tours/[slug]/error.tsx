        ...
        <div className="max-w-lg mx-auto">
          <div className="bg-white rounded-lg shadow-lg p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              There was a problem loading this tour. The page may not exist or there could be a temporary issue.
            </p>
            {error.message && (
              <p className="text-sm text-gray-500 mb-6 p-3 bg-gray-100 rounded">
                {error.message}
              </p>
            )}
